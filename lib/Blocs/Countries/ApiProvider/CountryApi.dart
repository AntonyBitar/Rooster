...
class CountryApi {
  ...
  CountryApi(this.httpClient);

  Future<Map<String, dynamic>> fetchClients(String search,int page) async {

    final uri = Uri.parse(kCountryUrl).replace(queryParameters: {
      'name': search,
      'isPaginated': '1',
      'page':page.toString(),
      'perPage':'15',
    ...
    if (response.statusCode != 200) {
      throw Exception('Failed to load suppliers creation');
    }
